...
Grid::Grid(int imax_init, int jmax_init, int boundary_size_init,double& TI, double& PI, double& UI, double& VI):
    ...
    _cells.resize(Grid::imaxb(), std::vector<Cell>(Grid::jmaxb(), Cell(TI,PI, UI, VI)));
